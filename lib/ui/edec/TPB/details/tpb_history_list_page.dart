...
import 'menu/tpb_details_menu_page.dart';

class TpbHistoryListPage extends StatefulWidget {
  const TpbHistoryListPage({super.key});

  @override
  State<TpbHistoryListPage> createState() => _TpbHistoryListPageState();
}

class _TpbHistoryListPageState extends State<TpbHistoryListPage> {
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const TpbDetailsMenuPage(),
                  ),
                );
              },
